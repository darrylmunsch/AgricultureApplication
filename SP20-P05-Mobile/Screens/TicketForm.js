            ...
            <View style={ticketForm.container}>
                {this.state.step === 1 ? (
                    <View style={ticketForm.container}>
                        ...
                        >
                            <Picker.Item label={"Choose Field..."} value={"Choose Field..."}/>
                ...
                {this.state.step === 2 ? (
                    <View style={ticketForm.container}>
                        ...
                        <FormTextInput placeholder={"How many small buckets?"} keyboardType={'numeric'} onChangeText={this.setNumBuckets}/>
                        {this.state.error !== "" ? (<Text style={{color: "#ff0000"}}>{this.state.error}</Text>) : null}
                        <Text>Medium Bucket Price: ${this.state.mdBucketPrice}</Text>
                        <FormTextInput placeholder={"How many medium buckets?"} keyboardType={'numeric'}/>
                        <Text>Large Bucket Price: ${this.state.lgBucketPrice}</Text>
                        <FormTextInput placeholder={"How many large buckets?"} keyboardType={'numeric'}/>

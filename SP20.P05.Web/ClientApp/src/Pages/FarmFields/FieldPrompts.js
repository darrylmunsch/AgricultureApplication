import { GiBerryBush } from "react-icons/gi";
import React from "react";

const FieldPrompts = {
  blueberryPrompt: {
    MTitle: [<GiBerryBush />, "Blueberry Field"],
    MBody:
    ...
    MFooter: "Purchase Tickets"
  },
  strawberryPrompt: {
    MTitle: "Strawberry Field",
    MBody:
